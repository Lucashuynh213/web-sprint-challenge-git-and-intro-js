...
function removeArtist(array, number) {
 let deletedArtists = [...array];
 for(let i = 0; i < array.length; i++){
  if(array[i].id === number){
    deletedArtists.splice(i, 1)
  }
...
function addArtist(array,name,years,genre,nationality,bio) {
  const copyArtists3 = {name,years,genre,nationality,bio}
  array.push(copyArtists3);
  return array;
}
console.log('Task 7',addArtist(artists,'John Doe', 1988-2022, 'Full Stack Development', 'African American', 'I have background in customer service at Big RetailChain. I am attending BloomTech to become a Frontend Developer.'));
